...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\setlength\figureheight{3cm}
		\setlength\figurewidth{6cm}
		\input{figures/fire-detection-results/mamdani/mamdani-T100_S90_L900_H0_D20.tikz}
...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\setlength\figureheight{3cm}
		\setlength\figurewidth{6cm}
		\input{figures/fire-detection-results/interpolation/example/interpolation-O-Oz_Tmin_Mmean--T100_S90_L900_H0_D20.tikz}
