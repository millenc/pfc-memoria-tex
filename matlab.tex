...
\lstinputlisting[caption=Método de Mamdani y gráfica con resultados (\lstinline|functions/fire_detection_mamdani_plot.m|),inputencoding=cp1252]{./matlab/fire_detection_mamdani_plot.m}
...
\lstinputlisting[caption=Parser de parámetros opcionales (\lstinline|fire_detection_plot_input_parser.m|),inputencoding=cp1252]{./matlab/fire_detection_plot_input_parser.m}
